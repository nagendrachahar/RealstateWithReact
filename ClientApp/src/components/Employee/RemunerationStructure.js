...
export class RemunerationStructure extends Component {
    ...
    FillForm(ID) {
        axios.get(`api/Masters/GetOneRemunerationStructure/${ID}`)
            .then(response => {
                ...
                UserInput["RemunerationPer"] = response.data[0].RemunerationPer;
    ...
    fillRemuneration() {
        axios.get('api/Masters/FillRemunerationStructure')
            .then(response => {
                console.log(response.data);
    ...
    handleSubmit(event) {
        ...
        const RemunerationStructure = this.state.FormGroup

        axios.post(`api/Masters/SaveRemunerationStructure`, RemunerationStructure)
            .then(res => {
                this.FillForm(0);
                this.setState({
    ...
    Delete(ID) {
        ...
        yesButton.addEventListener('click', () => {
            ...
            axios.get(`api/Masters/DeleteRemunerationStructure/${ID}`)
                .then(res => {
                    this.fillRemuneration();
                    this.setState({
                        Message: res.data[0].Message
                    ...
                    <tbody>
                        {RemunerationList.map((forecast, i) =>
                            ...
                            <tr key={forecast.RemunerationId}>
                                ...
                                <td>{forecast.RemunerationPer}</td>
                          ...
                          <div className="col-md-12 col-sm-12 col-xs-12">
                                ...
                                <div className="col-md-4 col-sm-12 col-xs-12">
                                  ...
                                  <input
                                    ...
                                    name="RemunerationPer"
                                    value={this.state.FormGroup.RemunerationPer}
