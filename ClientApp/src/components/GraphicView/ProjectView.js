...
export class ProjectView extends Component {
    ...
    Redirect = (ID) => {
        console.log(ID);
        this.props.history.push(`/GraphicViewSector/${ID}`);
    }
    ...
    render(){
        ...
        return (
                ...
                {ProjectList.map((forecast, i) =>
                    ...
                    <div key={forecast.ProjectId} onClick={this.Redirect.bind(this, forecast.ProjectId)} className="col-md-3 col-sm-3 col-xs-12 col-lg-3 p5">
                        <div className="bgRed">
                            <p>{forecast.ProjectName}</p>
                        </div>
                    </div>
                    )}
                </div>
